...
projects: true
hidden: true
description: "abrsim takes a real manifest and a network trace, simulates what an ABR player would do, and reports what it cost the viewer. Deterministically, offline, with n"
category: project
author: allan
externalLink: https://github.com/Allan-Nava/abrsim
github: Allan-Nava/abrsim
---
